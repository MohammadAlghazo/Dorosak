...
export const serverRoutes: ServerRoute[] = [
  ...
  { path: ':locale/certificates/verify/:verificationCode', renderMode: RenderMode.Server },
  { path: ':locale/certificates', renderMode: RenderMode.Client },
  { path: ':locale/certificates/:certificateId', renderMode: RenderMode.Client },
  ...
  { path: ':locale/about', renderMode: RenderMode.Server },
  { path: ':locale/contact', renderMode: RenderMode.Server },
  { path: ':locale/privacy', renderMode: RenderMode.Server },
  { path: ':locale/terms', renderMode: RenderMode.Server },
  { path: ':locale/faq', renderMode: RenderMode.Server },
